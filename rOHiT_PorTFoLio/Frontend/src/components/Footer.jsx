          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-3">
              {/* <Code2 className="w-8 h-8 text-white" aria-hidden="true" /> */}
                <span className="logo-audiowide text-xl font-bold text-cyan-400">ROHIT KUMAR</span>
            </Link>
            <p className="text-sm text-gray-400">
              Cyber Security Analyst based in Mathura , Uttar Pradesh , India.
            </p>
          </div>
        ...
        <div className="border-t border-white/10 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <span className="text-sm text-cyan-400 flex items-center gap-2 text-cyan-400">
                <svg
                  className="w-3 h-3"
                  fill="currentColor"
                  viewBox="0 0 32 32"
