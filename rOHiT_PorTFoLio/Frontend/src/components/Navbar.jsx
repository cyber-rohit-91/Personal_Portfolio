...
import { Code2, Menu, X , Shield,  ShieldCheck , Fingerprint, Lock ,BadgeCheck} from "lucide-react";
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center">
            ...
            <div className="flex-shrink-0">
              ...
              <span className="font-orbitron text-xl font-bold tracking-wider text-white">Rohit</span>
              {/* <span className="font-orbitron text-2xl font-bold tracking-widest text-cyan-400">Rohit</span> */}
              </Link>
            </div>
