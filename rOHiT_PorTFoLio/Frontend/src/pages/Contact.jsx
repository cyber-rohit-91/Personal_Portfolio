    ...
    <div className="min-h-screen pt-16 sm:pt-20 px-4 max-w-6xl mx-auto pb-16 sm:pb-20">
      ...
      >
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <MessageSquare className="w-7 h-7 sm:w-8 sm:h-8 text-cyan-400" />
          <h2 className="text-3xl sm:text-4xl font-bold text-cyan-400 py-5">
            Get in Touch
          </h2>
        </motion.div>
        <div className="grid lg:grid-cols-[1fr,1.5fr] gap-8 sm:gap-12">
          ...
          <div className="space-y-6 sm:space-y-8">
            <motion.div
              ...
              className="bg-gray-800/50 p-5 sm:p-6 rounded-xl backdrop-blur-sm text-cyan-400 border border-cyan-200"
            >
              <h3 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6 text-cyan-400">
                Contact Information
              </h3>
<hr className="w-100 mx-0 border-0 h-px bg-white/50 transition-all duration-300 my-0" />

              <div className="space-y-3 sm:space-y-4  my-3">
            ...
            <motion.div
              ...
              className="bg-gray-800/50 p-5 sm:p-6 rounded-xl backdrop-blur-sm border border-cyan-200"
            >
              <h3 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6 text-cyan-400">
                Connect with Me
              </h3>
<hr className="w-100 mx-0 border-0 h-px bg-white/50 transition-all duration-300 my-0" />
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4 my-5">
...
<hr className="w-100 mx-0 border-0 h-px bg-white/50 transition-all duration-300 my-0" />
              ...
              <div className="space-y-2 text-gray-400 text-sm sm:text-base my-4">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.4 }}
            className="bg-gray-800/50 p-6 sm:p-8 rounded-xl backdrop-blur-sm border border-cyan-200"
          >
            <h3 className="text-lg sm:text-xl font-semibold mb-6 text-cyan-400 ">
              Send a Message
            </h3>
<hr className="w-100 mx-0 border-0 h-px bg-white/50 transition-all duration-300 my-0" />
